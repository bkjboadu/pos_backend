...
class StockDetailView(APIView):
    ...
    def delete(self, request, pk):
        ...
        AuditLog.objects.create(
            ...
            resouce_id=deleted_stockinput_instance,
            details = f"StockInput {stockinput_instance.id} deleted"
        )

        return Response({"message":'StockInput instance successfully delete'}, status=200)
    ...
    def patch(self, request, pk):
        ...
        if serializer.is_valid():
            ...
            AuditLog.objects.create(
                ...
                performed_by=request.user,
                resource_name = "StockInput",
                resouce_id=stockinput_instance.id,
                details=details
            )
